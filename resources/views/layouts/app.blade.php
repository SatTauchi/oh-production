...
<body class="font-sans bg-background-color text-text-color min-h-screen flex flex-col">
    <header class="bg-gradient-to-r from-primary to-primary-dark text-white p-5 sticky top-0 z-50 shadow-md">
        <div class="container mx-auto flex justify-between items-center relative">
            <div class="w-10 invisible">
                <!-- 左側のスペーサー -->
            </div>
            
            <div class="absolute left-1/2 transform -translate-x-1/2 flex items-center">
                <img src="{{ asset('img/Logo.png') }}" alt="ロゴ" class="w-10 h-10 mr-2 object-contain">
                <span class="text-xl font-bold whitespace-nowrap">おさかなハぅマっチ？</span>
            </div>
            
            <div class="hamburger-menu relative">
                <input type="checkbox" id="menu-btn-check" class="hidden">
                <label for="menu-btn-check" class="menu-btn cursor-pointer flex flex-col justify-center items-center w-10 h-10">
    ...
    @auth
        <nav class="bg-primary-light py-2 sticky top-20 z-40">
